...
namespace il2cpp
{
	...
	namespace methods
	{
		...
		static auto image_get_class_count = LI_FIND_DEF(il2cpp_image_get_class_count);

		using il2cpp_image_get_class = size_t(*)(uintptr_t image, size_t index);
		static auto image_get_class = LI_FIND_DEF(il2cpp_image_get_class);
		...
		static auto class_get_namespace = LI_FIND_DEF(il2cpp_class_get_namespace);

		using il2cpp_class_get_name = const char* (*)(uintptr_t);
		static auto class_get_name = LI_FIND_DEF(il2cpp_class_get_name);
